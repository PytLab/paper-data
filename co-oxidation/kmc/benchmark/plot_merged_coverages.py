...
if "__main__" == __name__:
    ...
    # CO
    label = r'$\bf{CO^{*}}$'
    ax1.scatter(steps, CO_cvgs, alpha=0.5, facecolor="#93989A", edgecolor="#000000", label=label)
    # O
    label = r'$\bf{O^{*}}$'
    ax1.scatter(steps, O_cvgs, alpha=0.5, facecolor="#E0E0E0", edgecolor="#E41615", label=label)
    # Vac
    label = r'$\bf{*}$'
    ax1.scatter(steps, Vac_cvgs, alpha=0.5, facecolor="#93989A", edgecolor="#0F387A", label=label)
    ...
    # CO
    label = r'$\bf{CO^{*}}$'
    ax2.scatter(times, CO_cvgs, alpha=0.5, facecolor="#93989A", edgecolor="#000000", label=label)
    # O
    label = r'$\bf{O^{*}}$'
    ax2.scatter(times, O_cvgs, alpha=0.5, facecolor="#E0E0E0", edgecolor="#E41615", label=label)
    # Vac
    label = r'$\bf{*}$'
    ax2.scatter(times, Vac_cvgs, alpha=0.5, facecolor="#93989A", edgecolor="#0F387A", label=label)
