...
processes = [
    ...
    # CH4 adsorption
    {
        ...
        "elements_before": ['*_a', '*_c'],
        "elements_after": ['H_a', 'CH3_c'],
        "basis_sites": [0],
    },
    # 1st C-O coupling
    {
        ...
        "elements_before": ['*', 'CH3_c', '*_a'],
        "elements_after": ['*', '*_c', 'CH3_a'],
        "basis_sites": [0],
    },
    # 2nd C-H activation & 2nd C-O coupling
    {
        ...
        "elements_before": ['*_a', 'CH3_a', '*_a'],
        "elements_after": ['H_a', '-CH2_a', '-CH2_a'],
        "basis_sites": [0],
    },
    # O2 adsorption
    {
        ...
        "elements_before": ['*', '*_c', '-CH2_a', '-CH2_a'],
        "elements_after": ['*', 'O2_c', '-CH2_a', '-CH2_a'],
        "basis_sites": [0],
    },
    # 3nd C-H activation & reconstruction
    {
        ...
        "elements_before": ['*', 'O2_c', '-CH2_a', '-CH2_a'],
        "elements_after": ['*', 'OH_c', '*_a', 'CHO_a'],
        "basis_sites": [0],
    },
    # O2 adsorption besides CHO_o
    {
        ...
        "elements_before": ['*', 'CHO_a', '*_c'],
        "elements_after": ['*', 'CHO_a', 'O2_c'],
        "basis_sites": [0],
    },
    ...
    # H transfer b/w O2c
    {
        ...
        "elements_before": ['H_a', '*_a'],
        "elements_after": ['*_a', 'H_a'],
        "basis_sites": [0],
        "fast": True
    },
    # H transfer b/w O3c
    {
        ...
        "elements_before": ['*', 'H_b', '*_b'],
        "elements_after": ['*', '*_b', 'H_b'],
        "basis_sites": [0],
        "fast": True
    },
    # H -> O* from O2c
    {
        ...
        "elements_before": ['*', 'O_c', 'H_a'],
        "elements_after": ['*', 'OH_c', '*_a'],
        "basis_sites": [0],
    },
    # H -> O* from O3c
    {
        ...
        "elements_before": ['*', 'O_c', 'H_b'],
        "elements_after": ['*', 'OH_c', '*_b'],
        "basis_sites": [0],
    },
    # H -> OH* from O2c
    {
        ...
        "elements_before": ['*', 'OH_c', 'H_a'],
        "elements_after": ['*', '*_c', '*_a'],
        "basis_sites": [0],
    },
    # H -> OH* from O3c
    {
        ...
        "elements_before": ['*', 'OH_c', 'H_b'],
        "elements_after": ['*', '*_c', '*_b'],
        "basis_sites": [0],
    },
